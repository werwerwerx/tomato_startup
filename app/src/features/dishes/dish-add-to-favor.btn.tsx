...
export const AddToFavoritesButton = ({
  ...
  return (
    <button
      ...
      className={cn(
        "absolute top-2 right-2 z-10 flex h-10 w-10 items-center justify-center rounded-full border-2 bg-white/90 backdrop-blur-sm transition-all duration-300 hover:scale-110 hover:bg-white",
