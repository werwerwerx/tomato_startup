...
export function Container ({ children, className, ...props }: IContainerProps) {
  return (
    <div className={cn('w-full flex flex-col gap-5 container mx-auto px-4', className)} {...props}>
      {children}
    </div>
  );
}
...
export const FlexRowSection = ({ children, className, ...props }: IContainerProps & HTMLAttributes<HTMLElement>) => {
  return (
    <section className={cn('w-full flex flex-row gap-2 mx-auto items-center justify-center', className)} {...props}>
      {children}
    </section>
  );
};
export const FlexColSection = ({ children, className, ...props }: IContainerProps & HTMLAttributes<HTMLElement>) => {
  return (
    <section className={cn('w-full flex flex-col gap-2 mx-auto justify-center', className)} {...props}>
      {children}
    </section>
  );
};